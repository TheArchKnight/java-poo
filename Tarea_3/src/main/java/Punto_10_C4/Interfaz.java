...
public class Interfaz extends javax.swing.JFrame {
   ...
   private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
      ...
      est1.nombre = jTextField1.getText();
      est1.numeroInscripcion = Integer.parseInt(jTextField2.getText());
      est1.patrimonio = Double.parseDouble(jTextField3.getText());
      est1.estrato = Integer.parseInt(jTextField4.getText());

      jTextField5.setText(est1.texto());
